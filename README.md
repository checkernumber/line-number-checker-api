# Line Number Checker API — official examples | CheckNumber

This repository documents the CheckNumber Line Number Checker API integration contract using facts from the expansion manifest.

- Product page: https://checknumber.ai/products/line
...
```bash
curl -X POST "https://api.checknumber.ai/v1/tasks" -H "X-API-Key: ${CHECKNUMBER_API_KEY}" -F "file=@examples/numbers.txt" -F "task_type=line"
...
| --- | --- | --- | --- | --- | --- |
| `line` | Number Checker | phone | 2000–10000000 rows | `number, activated` | [docs](https://docs.checknumber.ai/line-bulk-number-checker) |
| `line_senior` | Profile Checker | phone | 2000–10000000 rows | `number, activated` | [docs](https://docs.checknumber.ai/line-profile-checker) |
...
- `line`: https://docs.checknumber.ai/line-bulk-number-checker
- `line_senior`: https://docs.checknumber.ai/line-profile-checker
